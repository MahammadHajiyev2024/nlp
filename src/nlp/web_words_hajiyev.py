...
# url: str = "https://en.wikipedia.org/wiki/Monetary_policy"
url: str = "https://en.wikipedia.org/wiki/Cryptocurrency"
...
STOP_WORDS = [
    "the", "and", "that", "with", "from", "this", "were", "they", "would",
    "also", "which", "their", "been", "used", "such", "than", "into",
    "money", "currency", "financial", "banks", "central"
]
...
filename = url.split("/")[-1].lower() + "_results.csv"
output_file = ROOT_PATH / "data" / filename
output_file.parent.mkdir(parents=True, exist_ok=True)


# Save the Polars DataFrame to your data folder
freq_df.write_csv(output_file)
